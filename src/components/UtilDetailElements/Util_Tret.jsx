...
const UtilTret = ({ hoveredUtilItem, scale, setCurrentMedia }) => {
  ...
  return (
    <div className="w-auto md:w-full h-full relative transition-all duration-300 md:z-[40]" ref={utilRef}>
      {/* Ảnh bản đồ */}
      <img
        className={`h-full max-w-none md:w-full object-contain absolute ${scale}`}
        src={tang_tret}
        alt="util_image"
      />
      <svg
