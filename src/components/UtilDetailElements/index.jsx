...
const UtilDetailElements = ({
  ...
  return (
    <div className="w-full h-screen bg-[#faffee] overflow-auto">
      {selectedUtilFilter === 1 || selectedUtilFilter === 2 ? (
        <></>
      ) : (
        <>
          <div className="flex gap-3 fixed top-5 right-20 md:right-28 md:top-5 z-50">
            <div
      ...
      flex gap-5 md:gap-10 justify-center items-center"
            ...
            <div className="pt-12">
              <ImagesUtil floor={1} block={block} isMobile={false} />
            </div>
          ) : selectedUtilFilter === 2 ? (
            <div className="pt-12">
              <ImagesUtil floor={3} block={block} isMobile={false} />
            </div>
          ) : null}
        </>
      )}
...
export default UtilDetailElements;
